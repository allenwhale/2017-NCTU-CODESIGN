...
#endif
    printf("process\n");
    *curr_bsum_addr = curr_bsum;
    *curr_addr = (int)(curr_image) | 0x10000000;
...
//    }
    ...
    *curr_addr = (int)(curr_image) | 0x20000000;
    *prev_addr = prev_image;
    *curr_bsum_addr = curr_bsum;
    *prev_bsum_addr = prev_bsum;
    while(*curr_addr);
    *curr_addr = mv;
    for (idy = 2; idy < ny-4; idy++)
    {
        for (idx = 2; idx < nx-4; idx+=2)
        {
