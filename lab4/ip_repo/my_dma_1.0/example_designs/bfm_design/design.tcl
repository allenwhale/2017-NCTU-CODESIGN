proc create_ipi_design { offsetfile design_name } {
	...
	set my_dma_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:my_dma:1.0 my_dma_0]
...
connect_bd_intf_net [get_bd_intf_pins slave_0/S_AXI] [get_bd_intf_pins my_dma_0/M00_AXI]
	...
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins slave_0/S_AXI_ACLK] [get_bd_pins my_dma_0/M00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins slave_0/S_AXI_ARESETN] [get_bd_pins my_dma_0/M00_AXI_ARESETN]
	...
	connect_bd_intf_net [get_bd_intf_pins master_0/M_AXI_LITE] [get_bd_intf_pins my_dma_0/S00_AXI]

	# Create port connections
	connect_bd_net -net aclk_net [get_bd_ports ACLK] [get_bd_pins master_0/M_AXI_LITE_ACLK] [get_bd_pins my_dma_0/S00_AXI_ACLK]
	connect_bd_net -net aresetn_net [get_bd_ports ARESETN] [get_bd_pins master_0/M_AXI_LITE_ARESETN] [get_bd_pins my_dma_0/S00_AXI_ARESETN]
	...
	set offset_file "${bd_path}/my_dma_v1_0_tb_include.vh"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:my_dma:1.0]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/my_dma_v1_0_tb.v
